...
<head>
    ...
    <link rel="stylesheet" href="landing/home/assets/w3.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.9.0/css/all.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.9.0/css/v4-shims.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <link href="{{asset('css/landing-page.css')}}" rel="stylesheet">
    <link rel="shortcut icon" href="home/assets/image/favicon/kbmti-ungu.png" type="image/x-icon">
    {{-- From Lucky --}}
    <link href="{{asset('css/Landing_Page.css')}}" rel="stylesheet">
    {{-- Wajib Footer.css di setiap page yang punya footer --}}
    {{-- Ada css yang tabrakan --}}
    ...
    <section class="top mb-md-3 ml-md-0 ml-4 ml-sm-2">
        <div class="row ml-md-5 ml-3" style="max-width: 70%; height: auto">
            ...
            <div class="col-md-6 col-12 d-flex d-sm-block d-md-block justify-content-center align-self-center h1" data-aos="zoom-in-right">
                <div id="title" class="col-12 col-md selamat">Selamat Datang</div><br>
                  <p class="pharagraph-top col-12 col-md karena" style="font-size: 22px;text-align:justify"><b>Karena berhimpun menjadi cara terampuh untuk menghapus batas potensi, merajut prestasi dan membentang bakti kepada negeri.</b></p>
            </div>

            <!-- <div class="col-md-6 col-12 mt-5 d-sm-inline-flex justify-content-center"> -->
            <div class="col-md-5 col-12 mt-3 d-md-flex d-md-block justify-content-center align-self-center gambar-alfa-reza">
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Jy9KfuwmdH4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                        </div>
                    </div>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="title">CPW x OSI : 
                                <br>Career Inspiration Talks</div>
